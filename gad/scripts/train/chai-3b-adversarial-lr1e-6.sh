#!/bin/bash
#
# GAD Adversarial Training Script for 3B Models (Qwen 3B)
#
# Model Size: 3B parameters
# Configuration: Uses same parameters as reference 7B script for minimal risk
# Note: With 8x B100 GPUs, conservative settings from proven 7B configuration
#
