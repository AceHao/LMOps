...
if [ -n "$MODEL_SIZE" ]; then
    ...
    echo "  cd verl && git checkout warmup && cd .."
    ...
    echo "  cd verl && git checkout gad && cd .."
    echo "  STEP=2204"
...
echo "  Warmup:      cd verl && git checkout warmup && cd .. && bash scripts/train/chai-3b-warmup-lr1e-6.sh --model /tmp/Qwen2.5-3B-Instruct --reward_model /tmp/Qwen2.5-3B-Instruct --exp_name chai-3b-warmup --nnodes 1"
echo "  Adversarial: cd verl && git checkout gad && cd .. && bash scripts/train/chai-3b-adversarial-lr1e-6.sh --exp_name chai-3b-adversarial --resume_step 2204 --nnodes 1"
echo ""
echo "7B model:"
echo "  Warmup:      cd verl && git checkout warmup && cd .. && bash scripts/train/chai-7b-warmup-lr1e-6.sh --model /tmp/Qwen2.5-7B-Instruct --reward_model /tmp/Qwen2.5-7B-Instruct --exp_name chai-7b-warmup --nnodes 1"
echo "  Adversarial: cd verl && git checkout gad && cd .. && bash scripts/train/chai-7b-adversarial-lr1e-6.sh --exp_name chai-7b-adversarial --resume_step 2204 --nnodes 1"
echo ""
echo "14B model:"
echo "  Warmup:      cd verl && git checkout warmup && cd .. && bash scripts/train/chai-14b-warmup-lr1e-6.sh --model /tmp/Qwen2.5-14B-Instruct --reward_model /tmp/Qwen2.5-14B-Instruct --exp_name chai-14b-warmup --nnodes 1"
echo "  Adversarial: cd verl && git checkout gad && cd .. && bash scripts/train/chai-14b-adversarial-lr1e-6.sh --exp_name chai-14b-adversarial --resume_step 2204 --nnodes 1"
echo ""
echo "235B model:"
echo "  Warmup:      cd verl && git checkout warmup && cd .. && bash scripts/train/chai-235b-warmup-lr1e-6.sh --model /tmp/Qwen2.5-235B-Instruct --reward_model /tmp/Qwen2.5-235B-Instruct --exp_name chai-235b-warmup --nnodes 1"
echo "  Adversarial: cd verl && git checkout gad && cd .. && bash scripts/train/chai-235b-adversarial-lr1e-6.sh --exp_name chai-235b-adversarial --resume_step 2204 --nnodes 1"
echo ""
